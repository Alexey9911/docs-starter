...
api: "GET https://api.chainguard.dev/v1/risk/score/{entity}"
...
```bash cURL
curl --request GET \
  --url 'https://api.chainguard.dev/v1/risk/score/0x742d35Cc6634C0532925a3b844Bc454c459dFE2C?chain=ethereum' \
...
const response = await fetch(
  `https://api.chainguard.dev/v1/risk/score/${entity}?chain=ethereum`,
  {
...
response = requests.get(
    f'https://api.chainguard.dev/v1/risk/score/{entity}',
