...
api: "GET https://api.chainguardai.dev/v1/risk/score/{entity}"
...
const response = await fetch(
  `https://api.chainguardai.dev/v1/risk/score/${entity}?chain=ethereum`,
  {
...
response = requests.get(
    f'https://api.chainguardai.dev/v1/risk/score/{entity}',
