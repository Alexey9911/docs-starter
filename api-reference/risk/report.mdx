...
api: "GET https://api.chainguardai.dev/v1/risk/report/{entity}"
...
const response = await fetch(
  `https://api.chainguardai.dev/v1/risk/report/${address}?chain=ethereum`,
  {
...
response = requests.get(
    f'https://api.chainguardai.dev/v1/risk/report/{address}',
