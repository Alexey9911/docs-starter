...
api: "GET https://api.chainguard.dev/v1/risk/report/{entity}"
...
```bash cURL
curl --request GET \
  --url 'https://api.chainguard.dev/v1/risk/report/0xdAC17F958D2ee523a2206206994597C13D831ec7?chain=ethereum' \
...
const response = await fetch(
  `https://api.chainguard.dev/v1/risk/report/${address}?chain=ethereum`,
  {
...
response = requests.get(
    f'https://api.chainguard.dev/v1/risk/report/{address}',
