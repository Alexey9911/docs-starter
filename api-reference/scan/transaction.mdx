...
api: "POST https://api.chainguardai.dev/v1/scan/transaction"
...
const response = await fetch('https://api.chainguardai.dev/v1/scan/transaction', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.chainguardai.dev/v1/scan/transaction',
    headers={
