...
<Steps>
  <Step title="Create Account">
    Sign up at [dashboard.chainguard.dev](https://dashboard.chainguard.dev)
  </Step>
...
```bash
curl --request GET \
  --url https://api.chainguard.dev/v1/risk/score/0x742d35Cc6634C0532925a3b844Bc454c459dFE2C \
...
```bash
curl --request GET \
  --url 'https://api.chainguard.dev/v1/risk/score/0x...?api_key=cg_live_xxxxxxxx'
```
