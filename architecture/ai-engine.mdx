---
title: "AI Engine"
description: "How CryptoGuard models evaluate risk"
icon: "brain"
---
...
When model confidence is low, CryptoGuard will bias toward warning instead of blocking. This keeps you in control while still surfacing potential risk.
