...
description: "How CryptoGuard is structured end to end"
icon: "sitemap"
---

CryptoGuard is designed as a lightweight client with a security intelligence backend. Most decisions are made close to the user, with deeper analysis performed only when needed.
...
If the gateway is unavailable, CryptoGuard falls back to local checks and shows a reduced-confidence warning. You still get protection, but deep analysis and enrichment may be delayed.
