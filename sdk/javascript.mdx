...
description: "Official JavaScript/TypeScript SDK for ChainGuard API"
icon: "js"
---
...
interface ChainGuardConfig {
  ...
  baseUrl?: string;               // Default: https://api.chainguard.dev
...
```html
<script src="https://cdn.chainguard.dev/sdk/v1/chainguard.min.js"></script>
<script>
