...
![CryptoGuard Web3 security banner](/images/banner%20x%203x.png)

Use this quick start to install CryptoGuard, trigger your first scan, and understand the most important signals you will see in the extension.
